									...
									<table class="alt">
										...
										<tbody>
											...
											<tr>
												...
												<td><center><a  class="special small button" href="<?php echo site_url('trackandfield/'.$link.'/'.$rows->id_num); ?>"> <?php echo $link; ?></a></center></td>
												
												<td><center><a  class="small button" href="<?php echo site_url('trackandfield/view_details/'.$rows->id_num); ?>">View Details</a></center></td>
											</tr>
											<?php endforeach; ?>
											<?php else: ?>
