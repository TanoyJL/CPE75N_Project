...
<body>
	...
	<h1>Try-Out Form</h1>
		First Name: <input type="text" name="first_name" id="first_name" /><br />
			...
			Height(ft): <input type="number" name="height" id="height" /><br />
			...
			<input type="checkbox" name="player_position" value="goal keeper"> Goal Keeper
			  <input type="checkbox" name="player_position" value="defense"> Defense
			  <input type="checkbox" name="player_position" value="mid field"> Mid Field
			  <input type="checkbox" name="player_position" value="forward"> Forward<br>
