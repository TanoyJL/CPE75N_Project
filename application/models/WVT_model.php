	...
	class WVT_model extends CI_Model{
		...
		function add_records($data){
			'firstname'=> $this->input->post('firstname'),
				...
				'preferred_position_setter'=> $this->input->post('preferred_position_setter'),
				'preferred_position_libero'=> $this->input->post('preferred_position_libero'),
				'preferred_position_openhitter'=> $this->input->post('preferred_position_openhitter'),
				'preferred_position_middlehitter'=> $this->input->post('preferred_position_middlehitter'),
